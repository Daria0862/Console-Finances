...
let totalChange = 0;
let prevMonthProfit = data[0][1];

for (let i = 1; i < data.length; i++) {
   const monthProfit = data[i][1];
   const monthChange = monthProfit - prevMonthProfit;
...
for (let i = 0; i < data.length - 1; i++) {
   const currentMo = data[i][0];
   const currentProfit = data[i][1];
   const nextMo = data[i + 1][0];
   const nextProfit = data[i + 1][1];
   const profitInc = nextProfit - currentProfit;

   if (profitInc > greatestInc) {
      greatestInc = profitInc;
      greatestIncMo = nextMo;
   }
}
